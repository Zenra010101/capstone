...
public static class SampleCatalogSeeder
{
    ...
    public static async Task SeedDemoPartiesAsync(AppDbContext context, CancellationToken cancellationToken = default)
    {
        ...
        context.Customers.AddRange(
            new Customer { CustomerCode = "CUS-0001", Name = "Juan Dela Cruz", Phone = "09171234567", Address = "General Santos City" },
            new Customer { CustomerCode = "CUS-0002", Name = "ABC Construction Supply", Phone = "09189876543", Email = "abc@example.com" },
            new Customer { CustomerCode = "CUS-0003", Name = "Maria Santos Hardware", Phone = "09201112233" });
        await context.SaveChangesAsync(cancellationToken);
