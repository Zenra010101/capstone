...
public class GoodsReturnSlipsController : ControllerBase
{
    ...
    public GoodsReturnSlipsController(
        IGoodsReturnSlipService service,
        IGrsExportService exportService,
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var approval = await _approvalService.CreateReturnRequestAsync(
                new CreateReturnApprovalRequest
                {
                ...
                cancellationToken);
            return Ok(ApiResponse<CreateApprovalRequestResult>.Ok(
                approval,
                "Return request submitted for owner approval"));
        }
